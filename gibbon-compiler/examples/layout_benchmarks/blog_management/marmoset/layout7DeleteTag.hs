...
deleteKeywordInTagList :: Text -> Blog -> Blog 
deleteKeywordInTagList keyword blogs = case blogs of 
                                            End -> End 
                                            Layout7 rst content header id author date tags -> let 
                                                                                                ...
                                                                                                in Layout7 newRst content header id author date newTags
...
gibbon_main = 
   let 
       ...
       blogs     = mkBlogs_layout7 10000
       --_ = printPacked blogs
       --_ = printsym (quote "NEWLINE")
       --_ = printsym (quote "NEWLINE")
       keyword :: Vector Char  
       keyword = "31517"
       newblgs = iterate (deleteKeywordInTagList keyword blogs)
